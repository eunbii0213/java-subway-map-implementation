...
public class ErrorView extends View {
    ...
    private static final String FIND_STATION_ERROR = "올바른 역 이름을 입력해주세요.";
    private static final String FIND_LINE_ERROR = "올바른 노선 이름을 입력해주세요.";
    private static final String USER_INPUT_NUMBER_ERROR_MESSAGE = "올바른 순서를 입력하세요.";
    private static final String SAME_STATION_ERROR_MESSAGE = "이미 추가된 역입니다.";

    public static void sameStationError() {
        System.out.println(ERROR_MESSAGE + SAME_STATION_ERROR_MESSAGE);
    }

    public static void userNumberInputError() {
        System.out.println(ERROR_MESSAGE + USER_INPUT_NUMBER_ERROR_MESSAGE);
    }

    public static void findLineError() {
        System.out.println();
        System.out.println(ERROR_MESSAGE + FIND_LINE_ERROR);
    }

    public static void findStationError() {
        System.out.println();
        System.out.println(ERROR_MESSAGE + FIND_STATION_ERROR);
    }
