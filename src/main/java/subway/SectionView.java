...
public class SectionView extends View{
    ...
    private static final String SECTION_REMOVE_LINE_GUIDE_MESSAGE = "## 삭제할 노선 이름을 입력하세요.";
    private static final String SECTION_REMOVE_STATION_GUIDE_MESSAGE = "## 삭제할 노선 이름을 입력하세요.";
